...
from main import load_data_on_gpu, test, train
...
def main():
    ...
    model = WraperModel(num_classes=8, feature_extraction=True,batch_norm=True,dropout=True)#SimpleModel(input_d=C*H*W, hidden_d=300, output_d=8)
